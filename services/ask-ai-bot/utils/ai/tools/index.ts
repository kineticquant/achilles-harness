...
export const aiTools = {
  search_docs: tool({
    description: "Search the Achilles documentation for relevant information",
  ...
  search_codebase: tool({
    description:
      "Search the Achilles source code (Rust crates and TypeScript UI) using regex patterns. Searches across ui/ and crates/. Use this to find function definitions, struct/type definitions, imports, error messages, or any code pattern.",
    inputSchema: z.object({
      query: z
        .string()
        .describe(
  ...
  search_github: tool({
    description:
      "Search GitHub issues and pull requests in the kineticquant/achilles-harness repository. Use this to find bugs, feature requests, or discussions. Results can be sorted by recency, relevance, or comment count.",
    inputSchema: z.object({
      query: z
        .string()
        .describe(
  ...
  get_github_issue_or_pr: tool({
    description:
      "Get detailed information about a specific GitHub issue or pull request in the kineticquant/achilles-harness repository, including its description and comments.",
    inputSchema: z.object({
