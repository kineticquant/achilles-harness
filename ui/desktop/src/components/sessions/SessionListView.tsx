...
const i18n = defineMessages({
  ...
  importNostrDesc: {
    ...
    defaultMessage: 'Paste an Achilles Nostr share link to fetch, decrypt, and import the session.',
  },
  ...
  chatHistoryDesc: {
    ...
    defaultMessage: 'View and search your past conversations with Achilles. {shortcut} to search.',
  },
