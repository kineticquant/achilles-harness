...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default Achilles starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. Achilles checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart Achilles to update existing windows.',
  },
  urlProtocolError: {
