...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, Achilles will notify you of new versions but will not download them automatically.',
  },
  ...
  autoDownload: {
    ...
    defaultMessage:
      'Achilles will download the update in the background and install it the next time you quit or restart.',
  },
  manualInstallNote: {
  ...
  readyInstallAuto: {
    ...
    defaultMessage:
      "✓ Update is ready. Restart Achilles to finish installing it, or quit when you're done.",
  },
  installNowHint: {
