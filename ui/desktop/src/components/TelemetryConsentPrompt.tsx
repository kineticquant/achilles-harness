...
const i18n = defineMessages({
  heading: {
    ...
    defaultMessage: 'Help improve Achilles',
  },
  description: {
    id: 'telemetryConsentPrompt.description',
    defaultMessage:
      'Would you like to share anonymous usage data to help improve Achilles? We never collect your conversations, code, or personal data.',
  },
  learnMore: {
