...
export const GOOSE_EXT_METHODS = [
  ...
  },
  {
    ...
    requestType: "AssessmentsStartRequest",
    responseType: "AssessmentsStartResponse",
  },
  {
    method: "_achilles/unstable/assessments/cancel",
    requestType: "AssessmentsCancelRequest",
    responseType: "AssessmentsCancelResponse",
  },
  {
    method: "_achilles/unstable/assessments/pause",
    requestType: "AssessmentsPauseRequest",
    responseType: "AssessmentsPauseResponse",
  },
  {
    method: "_achilles/unstable/assessments/list",
    requestType: "AssessmentsListRequest",
    responseType: "AssessmentsListResponse",
  },
  {
    method: "_achilles/unstable/assessments/get",
    requestType: "AssessmentsGetRequest",
    responseType: "AssessmentsGetResponse",
  },
  {
    method: "_achilles/unstable/findings/list",
    requestType: "FindingsListRequest",
    responseType: "FindingsListResponse",
  },
  {
    method: "_achilles/unstable/findings/setState",
    requestType: "FindingsSetStateRequest",
    responseType: "FindingsSetStateResponse",
  },
  {
    method: "_achilles/unstable/utils/run",
    requestType: "UtilsRunRequest",
    responseType: "UtilsRunResponse",
  },
] as const;
