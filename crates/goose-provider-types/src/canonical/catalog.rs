...
const SETUP_METADATA: &[CuratedSetupMetadata] = &[
    ...
    CuratedSetupMetadata {
        ...
        setup_method: ProviderSetupMethod::SingleApiKey,
        group: ProviderSetupGroup::Additional,
        display_name: Some("OpenCode Zen"),
        description: Some("OpenCode Zen models, including free SKUs"),
        docs_url: Some("https://opencode.ai/docs/zen"),
        aliases: &["opencode-zen", "zen"],
        native_connect_query: Some("OpenCode Zen"),
        binary_name: None,
        setup_capabilities: setup_capabilities(false, false, false),
        show_only_when_installed: false,
        synthetic: false,
    ...
    CuratedSetupMetadata {
        ...
        description: Some("OpenCode Go subscription models"),
        docs_url: Some("https://opencode.ai/docs/go"),
        aliases: &["opencode-go"],
        native_connect_query: Some("OpenCode Go"),
        binary_name: None,
        setup_capabilities: setup_capabilities(false, false, false),
        show_only_when_installed: false,
        synthetic: false,
